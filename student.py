...
class Student:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\Nitin\Desktop\facial recognition system\college_images\college_images\face-recognition.png")
        ...
        img1=Image.open(r"C:\Users\Nitin\Desktop\facial recognition system\college_images\college_images\smart-attendance.jpg")
        ...
        img2=Image.open(r"C:\Users\Nitin\Desktop\facial recognition system\college_images\college_images\iStock-182059956_18390_t12.jpg")
        ...
        img3=Image.open(r"C:\Users\Nitin\Desktop\facial recognition system\college_images\college_images\wp2551980.jpg")
        ...
        img_left=Image.open(r"C:\Users\Nitin\Desktop\facial recognition system\college_images\college_images\AdobeStock_303989091.jpeg")
        ...
        img_right=Image.open(r"C:\Users\Nitin\Desktop\facial recognition system\college_images\college_images\gettyimages-1022573162.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",user ="root",password="Nitin@123",database="face_recognizer")
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                Upadate=messagebox.askyesno("Upadte","Do you want to upate the student details ?",parent=self.root)
                if Upadate>0:
                    conn=mysql.connector.connect(host="localhost",user ="root",password="Nitin@123",database="face_recognizer")
                    my_cursor=conn.cursor()
